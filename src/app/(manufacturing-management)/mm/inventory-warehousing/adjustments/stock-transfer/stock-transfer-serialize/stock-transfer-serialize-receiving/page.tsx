...
import { StockTransferSerializeReceiveView } from "@/modules/manufacturing-management/adjustments/stock-transfer/stock-transfer-serialize";
...
export default async function StockTransferSerializeReceivingPage() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                            ...
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="min-w-0 overflow-hidden">
                                    <BreadcrumbPage className="truncate max-w-[56vw] sm:max-w-[60vw] md:max-w-none">
                                        Stock Transfer Serialized Receiving
                                    </BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
                <StockTransferSerializeReceiveView />
            </main>
        </div>
    );
}
