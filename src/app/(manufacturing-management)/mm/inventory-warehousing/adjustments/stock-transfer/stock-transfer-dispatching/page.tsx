...
import { StockTransferDispatchView } from "@/modules/manufacturing-management/adjustments/stock-transfer";
...
export default async function StockTransferDispatchingPage() {
