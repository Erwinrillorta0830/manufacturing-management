...
import MaterialStagingModule from "@/modules/manufacturing-management/material-staging/MaterialStagingModule";
...
export default async function MaterialStagingPage() {
