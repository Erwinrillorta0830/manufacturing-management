...
import InvoicingModule from "@/modules/manufacturing-management/invoicing-and-billing/invoicing-old/InvoicingModule";
...
export default async function InvoicingPage() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="/mm/invoicing-and-billing/invoicing">Invoicing & Billing</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto bg-background flex flex-col p-3 sm:p-5">
                <InvoicingModule />
            </main>
        </div>
    );
