...
import { ProductTracingModule } from "@/modules/manufacturing-management/product-tracing/ProductTracingModule";
...
export default async function ProductTracingPage() {
