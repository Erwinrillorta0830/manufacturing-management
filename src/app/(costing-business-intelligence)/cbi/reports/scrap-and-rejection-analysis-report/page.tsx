...
import ScrapAndRejectionReportModule from "@/modules/business-intelligence-and-analytics/inventory/scrap-and-rejection-analysis-report/ScrapAndRejectionReportModule";

export const dynamic = "force-dynamic";

export const metadata = {
    title: "Scrap and Rejection Analysis Report | VOS ERP",
    description: "Summarizes material loss, scrap rates, rework hours, and primary defect categories."
};
...
export default async function ScrapAndRejectionAnalysisReportPage() {
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden sm:block shrink-0">
                                    <BreadcrumbLink href="/bia/inventory">Inventory</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
