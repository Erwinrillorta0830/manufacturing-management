...
import { StockTransferReceiveManualView } from "@/modules/manufacturing-management/adjustments/stock-transfer";
...
export default async function StockTransferReceiveManualPage() {
