...
import { StockTransferReceiveView } from "@/modules/manufacturing-management/adjustments/stock-transfer";
...
export default async function StockTransferReceivePage() {
