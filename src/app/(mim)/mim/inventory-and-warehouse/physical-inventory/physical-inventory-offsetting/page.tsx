...
import PhysicalInventoryOffsettingModule from "@/modules/manufacturing-management/physical-inventory-offsetting/PhysicalInventoryOffsettingModule";

export const dynamic = "force-dynamic";

export const metadata = {
    title: "Physical Inventory Offsetting | VOS ERP",
    description: "Reconcile shortage and surplus inventory stock discrepancies at product level with lot and batch traceability."
};
...
export default async function PhysicalInventoryOffsettingPage() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 bg-background space-y-4">
                <div>
                    <h2 className="text-xl font-extrabold tracking-tight text-foreground">Physical Inventory Offsetting Workspace</h2>
                    <p className="text-muted-foreground text-[11px] mt-0.5">
                        Balance shortage and overage discrepancies at product level while maintaining strict Lot and Batch traceability across manufacturing inventory.
                    </p>
                </div>
