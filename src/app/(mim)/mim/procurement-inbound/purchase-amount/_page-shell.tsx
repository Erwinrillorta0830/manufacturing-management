...
export default async function PurchaseAmountPageShell({
    children,
    detailLabel
}: {
    children: ReactNode;
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            <header className="relative z-10 flex h-14 shrink-0 items-center justify-between border-b bg-background shadow-sm sm:h-16 overflow-hidden">
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="/mm/purchase-amount">Procurement &amp; Inbound</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
                                {detailLabel && (
                                    <>
                                        <BreadcrumbItem className="hidden md:block shrink-0">
                                            <BreadcrumbLink href="/mm/purchase-amount">Purchase Amount Posting &amp; Costing</BreadcrumbLink>
                                        </BreadcrumbItem>
                                        <BreadcrumbSeparator className="hidden md:block shrink-0" />
                                    </>
                                )}
                                <BreadcrumbItem className="min-w-0 overflow-hidden">
                                    <BreadcrumbPage className="truncate max-w-[56vw] sm:max-w-[60vw] md:max-w-none">
                                        {detailLabel || "Purchase Amount Posting & Costing"}
                                    </BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
