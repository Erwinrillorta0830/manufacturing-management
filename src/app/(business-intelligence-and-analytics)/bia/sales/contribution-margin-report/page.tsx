...
import ContributionMarginReportModule from "@/modules/business-intelligence-and-analytics/sales/contribution-margin-report/ContributionMarginReportModule";

export const dynamic = "force-dynamic";

export const metadata = {
    title: "Contribution Margin Report | VOS ERP",
    description: "Measures net sales revenue minus variable manufacturing costs (direct materials, direct labor, variable overhead) per unit and line."
};
...
export default async function ContributionMarginReportPage() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden sm:block shrink-0">
                                    <BreadcrumbLink href="/bia/sales">Sales</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 bg-background space-y-4">
                <ContributionMarginReportModule />
            </main>
        </div>
    );
}
