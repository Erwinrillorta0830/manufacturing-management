...
import WipTrackingReportModule from "@/modules/business-intelligence-and-analytics/costing/wip-tracking-report/WipTrackingReportModule";

export const dynamic = "force-dynamic";

export const metadata = {
    title: "WIP Tracking Report | VOS ERP",
    description: "Monitors active job statuses, work orders in progress, and stage completion across production lines."
};
...
export default async function WipTrackingReportPage() {
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden sm:block shrink-0">
                                    <BreadcrumbLink href="/bia/costing">Costing</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
