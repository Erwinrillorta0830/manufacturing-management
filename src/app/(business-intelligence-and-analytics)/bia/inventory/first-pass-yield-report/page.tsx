...
import FirstPassYieldReportModule from "@/modules/business-intelligence-and-analytics/inventory/first-pass-yield-report/FirstPassYieldReportModule";

export const dynamic = "force-dynamic";

export const metadata = {
    title: "First-Pass Yield (FPY) Report | VOS ERP",
    description: "Measures the percentage of units produced correctly without needing rework or repair."
};
...
export default async function FirstPassYieldReportPage() {
