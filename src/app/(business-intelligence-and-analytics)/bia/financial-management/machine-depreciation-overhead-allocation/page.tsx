...
import MachineDepreciationOverheadAllocationModule from "@/modules/business-intelligence-and-analytics/financial-management/machine-depreciation-overhead-allocation/MachineDepreciationOverheadAllocationModule";

export const dynamic = "force-dynamic";

export const metadata = {
    title: "Machine Depreciation Overhead Allocation | VOS ERP",
    description: "Converts equipment depreciation into hourly overhead burden rates to absorb machine costs directly into Cost of Goods Manufactured (COGM)."
};
...
export default async function MachineDepreciationOverheadAllocationPage() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden sm:block shrink-0">
                                    <BreadcrumbLink href="/bia/financial-management">Financial Management</BreadcrumbLink>
                                </BreadcrumbItem>
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 bg-background space-y-4">
                <MachineDepreciationOverheadAllocationModule />
            </main>
        </div>
    );
}
