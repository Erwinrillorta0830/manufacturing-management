...
export const WAREHOUSE_RECEIVING_QUEUE_INVENTORY_STATUS_IDS = [
    INVENTORY_STATUS.APPROVED,
    INVENTORY_STATUS.PARTIALLY_RECEIVED,
    INVENTORY_STATUS.WAREHOUSE_RECEIVING,
    INVENTORY_STATUS.FOR_PICKUP
...
export const WAREHOUSE_RECEIVING_STARTABLE_INVENTORY_STATUS_IDS = [
    INVENTORY_STATUS.APPROVED,
    INVENTORY_STATUS.PARTIALLY_RECEIVED,
    INVENTORY_STATUS.WAREHOUSE_RECEIVING
] as const;
...
export function inventoryStatusToShipmentStatus(statusId?: number | null, paymentStatus?: number | null): ShipmentStatusLabel {
    ...
    switch (statusId) {
        ...
        case INVENTORY_STATUS.REVISION: return "Revision";
...
export function shipmentStatusToInventoryStatus(status: string): InventoryStatusId {
    switch (status) {
        ...
        case "Revision": return INVENTORY_STATUS.REVISION;
