export const RECEIVING_ERROR_CODES = {
    ...
    STORAGE_LOT_UOM_MISMATCH: "STORAGE_LOT_UOM_MISMATCH",
    STORAGE_LOT_PRODUCT_TYPE_MISMATCH: "STORAGE_LOT_PRODUCT_TYPE_MISMATCH",
    STORAGE_LOT_CAPACITY_EXCEEDED: "STORAGE_LOT_CAPACITY_EXCEEDED",
    STORAGE_LOT_NEGATIVE_BALANCE: "STORAGE_LOT_NEGATIVE_BALANCE",
