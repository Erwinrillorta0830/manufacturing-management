...
const statusPatchSchema = z.object({
    orderId: positiveId,
    orderStatus: z.enum(["Draft", "Pending", "For Approval", "For Revision", "For Production", "For Invoicing", "For Consolidation", "In Production", "For Picking", "For Loading", "On Hold", "For Cancellation", "Cancelled", "For Shipping", "En Route", "Partially Delivered", "Delivered", "Not Fulfilled"]),
