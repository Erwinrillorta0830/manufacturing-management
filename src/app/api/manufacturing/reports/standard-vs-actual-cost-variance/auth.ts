...
const MODULE_PATH = "/mm/reports/standard-vs-actual-cost-variance";
...
export async function authorizeStandardVsActualCostVarianceReport(): Promise<ReportAccessResult> {
