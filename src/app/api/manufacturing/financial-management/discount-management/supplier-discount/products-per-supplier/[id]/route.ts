...
} from "@/modules/manufacturing-management/financial-management/discount-management/supplier-discount/services/products-per-suppliers";
import { NextRequest, NextResponse } from "next/server";

/**
 * PATCH /api/fm/supplier-discount/products-per-supplier/[id]
...
/**
 * DELETE /api/fm/supplier-discount/products-per-supplier/[id]
