...
export async function GET(req: NextRequest) {
    try {
        ...
        // 3. Gather all customer codes across Sales Orders
        const customerCodes = [
            ...new Set([
        ...
        // Process Sales Orders (Show orders in 'For Consolidation' status that do not have active consolidator details)
        ...
        console.error("consolidation-planning candidates GET error:", e);
