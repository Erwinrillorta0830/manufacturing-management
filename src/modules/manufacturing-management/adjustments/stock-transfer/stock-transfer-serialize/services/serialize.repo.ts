import { fetchItems, bulkUpdateItems } from "@/modules/manufacturing-management/adjustments/stock-transfer/services/api";
import type { 
...
export async function fetchStockTransferGroups(params: {
  ...
  const { groupByOrderNo } = await import("@/modules/manufacturing-management/adjustments/stock-transfer/services/stock-transfer.helpers");
