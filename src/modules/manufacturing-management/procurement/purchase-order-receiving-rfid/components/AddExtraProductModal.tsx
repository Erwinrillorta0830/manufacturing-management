...
export function AddExtraProductModal({ isOpen, onClose }: AddExtraProductModalProps) {
    ...
    const handleAddToList = (product: SupplierProduct) => {
        ...
        // âœ… IMPORTANT: In RFID, mark as verified but DO NOT auto-navigate to tagging. Let user decide.
                                        ...
                                        <div key={p.productId} className={cn(
                                            ...
                                            <div className="flex items-center justify-between mt-auto pt-2 border-t border-border/50">
                                                <div className="flex items-baseline gap-1">
                                                    <span className="font-black text-sm">â‚±{p.unitPrice.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
