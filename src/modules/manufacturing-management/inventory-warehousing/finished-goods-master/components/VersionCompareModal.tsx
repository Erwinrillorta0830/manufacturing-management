...
export const VersionCompareModal: React.FC<VersionCompareModalProps> = ({
    ...
    useEffect(() => {
        ...
        async function fetchComparison() {
            ...
            setError(null);
            try {
                let url = `/api/manufacturing/inventory-warehousing/finished-goods-master/versions/approvals/compare?targetVersionId=${targetVersionId}&baseVersionId=${baseVersionId}`;
