...
export const OverheadManagementTab: React.FC<OverheadManagementTabProps> = ({
    ...
    const handleRegisterNewOverheadType = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("/api/manufacturing/inventory-warehousing/finished-goods-master/overhead-types", {
                method: "POST",
            ...
            if (data.success && data.type) {
                ...
                const refreshRes = await fetch("/api/manufacturing/inventory-warehousing/finished-goods-master/overhead-types");
                if (refreshRes.ok) {
