...
interface SalesOrderApprovalDetailPanelProps {
    ...
    handleSendToConsolidation: (orderId: number) => void;
                        ...
                        <div className="flex justify-between items-start border-b border-border pb-4">
                            <div>
                                <div className="flex items-center gap-2.5">
                                    ...
                                    <span className={`inline-flex px-2.5 py-0.5 rounded-full text-[8.5px] font-black uppercase tracking-wider whitespace-nowrap ${selectedOrder.order_status === "For Consolidation" || selectedOrder.order_status === "For Picking"
                        ...
                        <div className="flex justify-end gap-3">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    handleSendToConsolidation(selectedOrder.order_id);
                                }}
                                disabled={updatingStatusId === selectedOrder.order_id}
