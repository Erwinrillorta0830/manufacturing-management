        ...
        <div className="va-container">
            ...
            {isReviewModalOpen && (
                <VersionReviewModal
                    ...
                    onSuccess={(action) => {
                        let text = "Approval decision submitted successfully!";
                        if (action === "revision") text = "Revision requested successfully!";
                        if (action === "reject") text = "Version rejected successfully!";
                        if (action === "approve") text = "Version approved successfully!";
