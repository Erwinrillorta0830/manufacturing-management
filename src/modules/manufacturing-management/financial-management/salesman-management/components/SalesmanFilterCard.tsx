...
export function SalesmanFilterCard({
    ...
    return (
        <Card className="shadow-sm border-muted-foreground/10 overflow-hidden">
            <CardHeader className="py-4 px-6 flex flex-row items-center justify-between border-b bg-muted/50">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <div className="w-full md:w-48">
                        ...
                        <Select value={statusFilter} onValueChange={setStatusFilter}>
                            <SelectTrigger className="h-10 text-xs font-black uppercase tracking-widest border-muted-foreground/20 rounded-xl shadow-sm bg-background">
