...
export function usePaymentTerms() {
  ...
  useEffect(() => {
    async function getTerms() {
      try {
        const response = await fetch("/api/manufacturing/financial-management/discount-management/supplier-discount/payment-terms");
...
export function useDeliveryTerms() {
  ...
  useEffect(() => {
    async function getTerms() {
      try {
        const response = await fetch("/api/manufacturing/financial-management/discount-management/supplier-discount/delivery-terms");
