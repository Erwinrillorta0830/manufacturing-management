...
} from "@/modules/manufacturing-management/financial-management/discount-management/supplier-discount/types/representative.schema";
...
export function useRepresentatives(supplierId: number | null) {
  ...
  const fetchRepresentatives = useCallback(async (id: number) => {
    try {
      ...
      const response = await fetch(
        `/api/manufacturing/financial-management/discount-management/supplier-discount/representatives?supplier_id=${id}`,
      );
  ...
  const addRepresentative = useCallback(
    async (data: Omit<RepresentativeFormValues, "supplier_id">) => {
      ...
      try {
        ...
        const response = await fetch(
          "/api/manufacturing/financial-management/discount-management/supplier-discount/representatives",
          {
            method: "POST",
            headers: {
  ...
  const removeRepresentative = useCallback(
    async (id: number) => {
      ...
      try {
        const response = await fetch(
          `/api/manufacturing/financial-management/discount-management/supplier-discount/representatives/${id}`,
          {
            method: "DELETE",
          },
        );
