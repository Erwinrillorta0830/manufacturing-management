...
export async function getLookups() {
  return http<{ data: Lookups }>("/api/manufacturing/sales-management/salesman-qr-code/lookups");
}

export async function listSalesmen() {
  return http<{ data: SalesmanRow[] }>("/api/manufacturing/sales-management/salesman-qr-code/salesmen");
}
...
export async function updateSalesman(id: number, draft: SalesmanDraft) {
  return http<{ data: SalesmanRow }>(`/api/manufacturing/sales-management/salesman-qr-code/salesmen/${id}`, {
    method: "PATCH",
    body: JSON.stringify({ data: draft }),
  });
}
...
export async function listSalesmanQrCodes(salesmanId: number) {
  return http<{ data: SalesmanQrCodeRow[] }>(
    `/api/manufacturing/sales-management/salesman-qr-code/salesmen/${salesmanId}/qr-codes`,
  );
}
...
export async function upsertSalesmanQrCode(args: {
  ...
  const res = await fetch(
    `/api/manufacturing/sales-management/salesman-qr-code/salesmen/${args.salesmanId}/qr-codes`,
    {
      method: "POST",
      body: fd,
      credentials: "include",
